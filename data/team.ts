...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    title: 'Advisory Board',
    category: 'advisory',
    shortBio: 'Senior engineering and environmental professional with over 40 years\' experience leading technical teams across mining and infrastructure.',
  ...
  {
    name: 'Tien Dinh Van',
    title: 'Senior Technical Advisor - Civil & Construction',
    category: 'technical',
  ...
  {
    name: 'Hung Tran Huu',
    title: 'Senior Technical Advisor - EHS & Sustainability',
    category: 'technical',
